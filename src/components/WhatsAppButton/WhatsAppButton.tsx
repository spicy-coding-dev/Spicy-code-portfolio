...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  return (
    <a
      ...
      className={`fixed ${positionClass} z-50 flex md:h-12 md:w-12 h-10 w-10 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform duration-200 hover:scale-110 hover:shadow-xl`}
    >
