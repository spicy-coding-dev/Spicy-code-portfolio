...
const DEFAULT_WORDS = ["WELCOME", "TO", "SPICY CODE","5+","PROJECTS","5+","CLIENTS"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
  ...
  const animate = () => {
    ...
    ctx.fillStyle ="rgba(0, 0, 0, 0.1)"  // light blue blur
  ...
  return (
    <div className="flex flex-col items-center justify-center h-auto lg:p-4 p-0">
      <canvas
        ref={canvasRef}
